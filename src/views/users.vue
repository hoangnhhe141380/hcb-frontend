    ...
    <div>
        <div class="panel pb-0 mt-6">
            <div class="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                <router-link to="/nguoi-dung/them" class="btn btn-success w-1/6">Thêm </router-link>
            ...
            <div class="datatable">
                ...
                >
                    <template #detail="data">
                        <router-link :to="{ name: 'users-detail', params: { username: data.value.username } }" class="text-primary hover:underline">
                            Chi tiết
                        </router-link>
                    </template>
                </vue3-datatable>
