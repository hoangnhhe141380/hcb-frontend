    ...
    <div>
        <div class="panel pb-0 mt-6">
            <div class="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                <h5 class="font-semibold text-lg dark:text-white-light">Danh sách giáo viên</h5>
...
useMeta({ title: 'Danh sách giáo viên' });
const search = ref('');
const cols =
    ref([
...
const fetchData = () => {// Replace with your API URL
    ...
    const apiUrl = import.meta.env.VITE_APP_API_URL + 'admin/teachers';
    axios.get(apiUrl)
        .then((response) => {
